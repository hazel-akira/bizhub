...
final smartInsightsProvider = FutureProvider<({String mostSoldItem, String bestSalesDay})>((
  ref,
) async {
  ...
  final mostSold = ndenguQty >= meatQty ? 'Ndengu' : 'Meat';
...
final todayPerformanceProvider = FutureProvider<({
  ...
  return (
    hasSales: true,
    totalSamosasSold: totalSamosasSold,
